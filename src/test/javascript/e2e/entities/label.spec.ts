...
describe('Label e2e test', () => {
    ...
    it('should load Labels', () => {
        ...
        expect(labelComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationNg2App.label.home.title/);
    ...
    it('should load create Label dialog', () => {
        ...
        expect(labelDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationNg2App.label.home.createOrEditLabel/);
